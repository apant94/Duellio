...
import Card1Path from '../../images/cases-card-1.png';
import Card2Path from '../../images/cases-card-2.png';
...
const CasesList = () => {
  ...
  const caseText = {
    ...
    text5:
      'Ресторану подарили антикварное стекло для оформления интерьера. Даритель отправил подарок через транспортную компанию на условиях, что транспортировку оплачивает получатель. По дороге стекло разбилось. Транспортная компания не считает себя виноватой, т.к. приняла груз в упаковке отправителя. И требует от получателя 10 тыс. ₽ за транспортировку. Как быть?',
  ...
  return (
    <>
      <div className="caseslist">
        ...
        <img
          src={Card1Path}
          alt="Изображение переговоров"
          className="caseslist__image"
        />
      ...
      <button
        className={`caseslist__button ${
          theme === 'day' ? '' : 'caseslist__button_theme_dark'
        }`}
        type="button"
      >
        Смотреть еще
